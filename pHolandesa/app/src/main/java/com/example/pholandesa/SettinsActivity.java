...
public class SettinsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePictureRef = FirebaseStorage.getInstance().getReference().child("Imagen de Perfil");
    ...
    private void userInfoSaved() {
        if (TextUtils.isEmpty(fullNameEditText.getText().toString())) {
            ...
            Toast.makeText(this, "La dirreción es obligatoria", Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage() {
        ...
        progressDialog.setMessage("Espere un momento, mientras actualizamos la información de su cuenta.");
